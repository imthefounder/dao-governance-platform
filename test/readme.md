...
- testContractInitialization
- testDepositSuccessfully
- testDepositFailsWithInsufficientAmount
- testDepositFailsWithInsufficientAllowance
- testWithdrawSuccessfully
- testWithdrawFailsWithInsufficientBalance
- testWithdrawFailsWithInsufficientAmount
- testBurnByBurnerSuccessfully
- testBurnByBurnerFailsForNonBurner
- testMintByVotingPowerExchange
- testMintFailsForNonVotingPowerExchange
- testTransferSuccessfully
- testTransferFailsWithInsufficientBalance
- testTransferFromSuccessfully
- testTransferFromFailsWithInsufficientAllowance
- testSetExchangeRate
- testSetExchangeRateFailsForNonManager
- testCalculationFunctions
- testEmergencyWithdraw
- testEmergencyWithdrawFailsForNonAdmin
- testApproveAndAllowance
- testConstants
